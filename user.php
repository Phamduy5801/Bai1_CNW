...
<body>
    ...
    <section class="main">
        <div class="container">
                ...
                <input type="button" class="btn btn-primary bt-add" value="Add new user">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td>Pham Quoc Duy 1</td>
                            <td>Phamduy01</td>
                            <td>
                                <div class="action-group">
                                    <input type="button" class="btn btn-primary" value="Change Password">
                                    <input type="button" class="btn btn-success" value="Update Admin">
                        ...
                        <tr>
                            <th scope="row">3</th>
                            <td>Pham Quoc Duy 3</td>
                            <td>Phamduy03</td>
                            <td>
                                <div class="action-group">
                                    <input type="button" class="btn btn-primary" value="Change Password">
                                    <input type="button" class="btn btn-success" value="Update Admin">
                                    <input type="button" onclick='submitForm()' class="btn btn-danger" type="submit" value="Delete">
                                 </div>
                            </td>
                        </tr>
                    </tbody>
